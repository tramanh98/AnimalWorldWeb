...
const flingTag = (props) =>{
    const followingPost = () =>{
        props.history.push(`/result?q=following`);
    }
    return(
        <a onClick={followingPost}>ĐANG THEO DÕI</a>
    );
}
const Profile = (props) => {
        ...
        <nav className={this.state.classNm}  >
            ...
            <div className="navother font-roboto-nav" id="wrap-navbar">
                ...
                style={{
                    ...
                    <If condition={this.props.user} props={this.props} component={flingTag} />
...
export default connect(mapStateToProps)(withRouter(NavFoot));